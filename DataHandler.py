...
class DataHandler:
	...
	def __init__(self):
		...
		self.imageIdfile = predir + 'image_id.npy'
		self.textIdfile = predir + 'text_id.npy'
		self.imagefile = predir + 'image_feat.npy'
		self.textfile = predir + 'text_feat.npy'
		if args.data == 'tiktok':
			self.audiofile = predir + 'audio_feat.npy'
			self.audioIdfile = predir + 'audio_id.npy'
	...
	def LoadData(self):
		...
		self.image_id, args.image_id_dim = self.loadFeatures(self.imageIdfile)
		self.text_id, args.text_id_dim = self.loadFeatures(self.textIdfile)
		...
		if args.data == 'tiktok':
			...
			self.audio_id, args.audio_id_dim = self.loadFeatures(self.audioIdfile)
